package org.movescan.config.datasource;
...
@EnableJpaRepositories(
        basePackages = "org.movescan.repository.starcoin.main",
        entityManagerFactoryRef = "mainEntityManagerFactory",
        transactionManagerRef = "mainTransactionManager"
)
public class StarcoinMainDatasourceConfiguration {
    @Autowired
...
//    private DataSource mainDataSource;
    ...
    @Bean
    @ConfigurationProperties(prefix = "spring.datasource.starcoin.main")
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(@Qualifier("mainEntityManagerFactoryBuilder") EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("org.movescan.entity") // 设置实体类所在位置
