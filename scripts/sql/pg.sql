...
(
    ...
    block_accumulator_root character varying
(
    255
) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    txn_accumulator_root character varying
(
    255
) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    state_root_hash character varying
(
    255
) COLLATE pg_catalog."default" NOT NULL,
    event_root_hash character varying
(
    255
) COLLATE pg_catalog."default" NOT NULL,
    ...
    accumulator_root_hash character varying
(
    255
) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    CONSTRAINT transactions_index_key UNIQUE
(
    global_index
)
    );
...
(
    ...
    CONSTRAINT user_transactions_pkey PRIMARY KEY
(
    txn_hash
),
    CONSTRAINT user_transactions_sender_sequence_number_key UNIQUE
(
    sender,
    sequence_number
)
...
(
    ...
    state_key_hash character varying
(
    255
) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    CONSTRAINT write_set_changes_pkey PRIMARY KEY
(
    txn_hash,
    state_key_hash
)
